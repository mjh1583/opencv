...
# [start_y:end_y, start_x:end_x]로 ROI 영역 지정
img_sub1 = img_gray[20:20+150, 20:20+150]

# img_sub1이 img_gray의 일부 데이터를 공유하기 때문에 True가 리턴
...
# img_sub1이 입력과는 다른 객체가 되므로 False가 리턴
print(img_sub1.base is img_gray)

# img_gray에는 영향을 주지 못하고 img_sub1만 이진화
